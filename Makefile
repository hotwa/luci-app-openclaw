...
define Package/$(PKG_NAME)/install
	...
	$(INSTALL_BIN) ./root/usr/libexec/openclaw-compat.sh $(1)/usr/libexec/openclaw-compat.sh
	$(INSTALL_BIN) ./root/usr/libexec/openclaw-wechat.sh $(1)/usr/libexec/openclaw-wechat.sh
