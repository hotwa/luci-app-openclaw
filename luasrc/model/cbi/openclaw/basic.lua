...
act.cfgvalue = function(self, section)
	...
	html[#html+1] = '(new XHR()).post("' .. ctl_url .. '?action=setup&version="+encodeURIComponent(version)+"&install_root="+encodeURIComponent(installRoot),{token:ocCsrfToken},function(x){'
